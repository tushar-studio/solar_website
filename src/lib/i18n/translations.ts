...
export const translations = {
  en: {
    ...
    contact: {
      ...
      mapCta: "Open Live Directions in Google Maps ↗",
      fullName: "Full Name *",
      phone: "Phone Number *",
      email: "Email Address",
    ...
    footer: {
      ...
      trustPills: ["MNRE Empanelled", "PM Surya Ghar Approved", "25-Year Panel Warranty"],
      calculators: [
        "System Capacity Calculator",
        "Government Subsidy Estimator",
        "Solar EMI & Bank Loan Tool",
        "ROI & Payback Period",
      ],
      scheme: [
        ...
        "DISCOM Net-Metering Help",
      ],
      helplineStatus: "24/7 Helpline Active",
  ...
  hi: {
    ...
    contact: {
      ...
      mapCta: "Google Maps में लाइव दिशा-निर्देश खोलें ↗",
      fullName: "पूरा नाम *",
      phone: "फोन नंबर *",
      email: "ईमेल पता",
    ...
    footer: {
      ...
      trustPills: ["MNRE मान्यता प्राप्त", "पीएम सूर्य घर अनुमोदित", "25 वर्ष पैनल वारंटी"],
      calculators: [
        "सिस्टम क्षमता कैलकुलेटर",
        "सरकारी सब्सिडी अनुमानक",
        "सोलर EMI और बैंक लोन टूल",
        "ROI और पेबैक अवधि",
      ],
      scheme: [
        ...
        "DISCOM नेट-मीटरिंग सहायता",
      ],
      helplineStatus: "24/7 हेल्पलाइन सक्रिय",
